    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, exports.fromGoogleGeoCode(googleResponse, options)];
        }
    });
}); };
...
function getGoogleGeoCode(addressText, options) {
    return __awaiter(this, void 0, void 0, function () {
        var response, googleAddressComponents;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("https://maps.googleapis.com/maps/api/geocode/json?address=" + "/maps/api/geocode/json?address=" +
                ...
                case 1:
                    ...
                    googleAddressComponents = response.data;
